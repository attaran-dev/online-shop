...
{/* <AnimationOnScroll animateIn="animate__fadeInRight"> */}
      {products.map((product, index) => {
        ...
        // <AnimationOnScroll animateIn="animate__fadeInRight" duration={2} animateOnce>
            <ProductCard key={`${props.value}-${index+1}`} id={index+1} productId={product.id} name={product.name} model={product.model} image={product.image} price={product.price} />
            // </AnimationOnScroll>
      )})}

      {/* </AnimationOnScroll> */}
      {/* <AnimationOnScroll animateIn="animate__fadeIn" duration={3} animateOnce> */}
              <div className="clef">
