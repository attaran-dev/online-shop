...
function SideMenu({children}) {
  return (
        <div className="drawer blur-2xl transition duration-1000"  onLoad={()=>{
          setTimeout(() => {
            document.getElementById("category-list").classList.remove("invisible")
            document.getElementsByClassName("drawer")[0].classList.remove("blur-2xl")
  ...
  <div className="drawer-side">
    ...
    <ul id="category-list" className="menu p-4 overflow-y-auto w-80 bg-base-100 text-base-content invisible">
